...
function Notes() {
  ...
  const notesToRender = filterApplied ? filteredNotes : notes;
    ...
    <div className="pt-16 min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <p className="text-center text-gray-600 max-w-2xl mx-auto mb-8">
          Browse through a wide collection of notes across various subjects and topics.
          Use the filters to find the exact material you need for study or reference.
        </p>
        ...
        <div className="mt-12 text-center">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto">
            Our notes are carefully curated to help students and learners access
            clear, accurate, and organized information. Whether you're revising
            for exams or exploring new subjects, our collection is designed to
